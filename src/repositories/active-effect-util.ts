...
export class ActiveEffectUtil {
    public async replaceActiveEffect(actor: Lvl0Actor, type: 'effect', id: string | number, data: Partial<ActiveEffectData>): Promise<void> {
    ...
    public async removeActiveEffect(actor: Lvl0Actor, type: 'effect', id: string | number) {
